...
include('navbar.php');    
  ...
  $e = "SELECT * from tblvotersinfo where status_id = 1 and barangay = 5";
...
<body>
   ...
   <div class="container center" >
    <?php 
          ...
          $seluid = "SELECT * FROM tblbarangay where ID = 5";
                ...
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                     <form action="cataningadd.php" method="POST">
                    <div class="row">
                      <div class=" col-sm-4">
              ...
              <div class="modal fade"  id="edit-<?php echo $db['ID']; ?>" role="dialog">
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                    <form action="cataningedit.php" method="POST">
                    <div class="row">
                      <div class=" col-sm-4">
                        <label>First Name</label>
              ...
              <div class="modal fade"  id="archieve-<?php echo $db['ID']; ?>" role="dialog">
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                   <form action="cataningarchieve.php" method="POST">
